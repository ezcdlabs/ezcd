...
export default class DSL {
  ...
  cli = {
    ...
    commitStageStarted: async (params: {
      project: string;
      ...
      const commitDate = params.commitDate
        ? dateFns.parse(params.commitDate, "yyyy-MM-dd HH:mm:ss", new Date())
        : new Date();
    ...
    commitStagePassed: async (params: {
      project: string;
      commitMessage: string;
    }) => {
      const projectId = this.getOrThrow(this.projects, params.project);
    ...
    commitStageFailed: async (params: {
      project: string;
      commitMessage: string;
    }) => {
      const projectId = this.getOrThrow(this.projects, params.project);
    ...
    acceptanceStageStarted: async (params: {
      project: string;
      commitMessage: string;
    }) => {
      const projectId = this.getOrThrow(this.projects, params.project);
    ...
    acceptanceStagePassed: async (params: {
      project: string;
      commitMessage: string;
    }) => {
      const projectId = this.getOrThrow(this.projects, params.project);
    ...
    acceptanceStageFailed: async (params: {
      project: string;
      commitMessage: string;
    }) => {
      const projectId = this.getOrThrow(this.projects, params.project);
  ...
  ui = {
    ...
    checkCommit: async (params: {
      ...
      const commit = await this.uiDriver.getProjectCommit({
        projectId,
        commitHash,
      });
